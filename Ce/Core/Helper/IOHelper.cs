    ...
    public class IOHelper
    {
        ...
        public static void WriteLogFile(string input)
        {
            lock (_locker)
            {
                ...
                try
                {
                    string fileName = GetMapPath("/App_Data/errorlogs/") + DateTime.Now.ToString("yyyyMMdd") + ".log";
        ...
        {          
            lock (_locker)
            {
                ...
                try
                {
                    string fileName = GetMapPath(ConfigurationManager.AppSettings[logpathName].Trim()) + DateTime.Now.ToString("yyyy年MM月dd日HH时") + ".log";
                    ...
                    sw.WriteLine("IP：" + WebHelper.GetIP());
                    sw.WriteLine("------------------------------------");                  
                }
                catch (Exception ex)
                {
