    ...
    public class DBUniversalHelper
    {
        ...
        static DBUniversalHelper()
        {
          ...
          //  _connectionstring = ConfigurationManager.ConnectionStrings["SqlConnection"].ConnectionString;
            ...
            //设置数据工厂
            _factory =SystemConfigData.DBProviderFactory;
            //_factory = SqlClientFactory.Instance;
            //设置关系数据库对象前缀
            _rdbstablepre = SystemConfigData.DBConInfo.DBTablePre;
            //设置关系数据库连接字符串
            _connectionstring = SystemConfigData.DBConInfo.DBConnectionString;
        }
